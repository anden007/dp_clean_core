...
func NewOpenPlatform(context *Component) *OpenPlatform {
	...
	cfg := &openplatformConfig.Config{
		AppID:          viper.GetString("component.mp.app_id"),
		AppSecret:      viper.GetString("component.mp.app_secret"),
		Token:          viper.GetString("component.mp.token"),
		EncodingAESKey: viper.GetString("component.mp.aes_key"),
